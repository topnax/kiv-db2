...
// #7 use aggregation to assign transactions to the portfolio they belong in
print()
print("#7 use aggregation to assign transactions to the portfolio they belong in")
